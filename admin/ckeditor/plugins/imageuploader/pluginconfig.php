...
$foldershistory[] = "giletta deportes/sitio/archivos/image";
        ...
        $useruploadfolder = "http://192.168.88.211/Ambar/site/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "http://192.168.88.211/Ambar/site/archivos/image";
        

        $useruploadfolder = "http://Ambar/site/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "http://Ambar/site/archivos/image";
        

        $useruploadfolder = "/Ambar/site/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "/Ambar/site/archivos/image";
        

        $useruploadfolder = "/site/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "/site/archivos/image";
        

        $useruploadfolder = "delyar/site/archivos/image";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "delyar/site/archivos/image";
        ...
        $useruploadfolder = "delyar/site/archivos/images";
        $useruploadpath = $usersiteroot."$useruploadfolder/";
        $foldershistory[] = "delyar/site/archivos/images";
