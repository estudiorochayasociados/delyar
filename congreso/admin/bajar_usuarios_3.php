...
while ($data = mysqli_fetch_array($resultado)) {
	echo "<tr>";
	echo "<td>".mb_strtoupper(htmlspecialchars($data["ApellidoInscripcion"]))."</td><td>".mb_strtoupper(htmlspecialchars($data["NombreInscripcion"]))."</td>";	
	echo "<td>".mb_strtoupper(htmlspecialchars($data["TipoInscripcion"]))."</td><td>".mb_strtoupper(htmlspecialchars($data["EmpresaInscripcion"]))."</td>";
	echo "</tr>";
}
